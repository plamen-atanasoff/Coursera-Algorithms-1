...
public class Point implements Comparable<Point> {
    private Comparator<Point> bySlopeOrder = null;
    ...
    public Comparator<Point> slopeOrder() {
        return bySlopeOrder == null ? bySlopeOrder = new BySlopeOrder(this) : bySlopeOrder;
    }

    private static class BySlopeOrder implements Comparator<Point> {
        private Point thisRef;

        private BySlopeOrder(Point thisRef) {
            this.thisRef = thisRef;
        }

        @Override
        public int compare(Point o1, Point o2) {
            double slope1 = thisRef.slopeTo(o1);
            double slope2 = thisRef.slopeTo(o2);
